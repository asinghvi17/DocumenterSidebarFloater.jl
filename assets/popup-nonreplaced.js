document.addEventListener("DOMContentLoaded", function () {
    const floater = document.querySelector(".admonition.is-category-REPLACE_ME_DFC_FLOATER_STYLE-floater");
    ...
    if (floater) {
        ...
        applyBaseStyles(floater, ".admonition.is-REPLACE_ME_DFC_FLOATER_STYLE");
...
function createFloaterLink(floater) {
    ...
    link.href = "REPLACE_ME_DFC_FLOATER_LINK";
